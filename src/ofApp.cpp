...
void ofApp::update(){
    ...
    if(kinect.isFrameNew()){
        ...
        contourFinder.findContours(grayDiff, 0, kinect.width*kinect.height, 3, true);
        ...
        for(int i = 0; i < contourFinder.nBlobs; i++){
           ...
           // tempVec2f.y = kinect.getHeight()-tempVec2f.y;
            cout << tempZ << endl;
            if(tempZ>1000 && tempZ<8000){
                float z = ofMap(tempZ, 1000, 8000, -100, 100);
